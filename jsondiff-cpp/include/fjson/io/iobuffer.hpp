...
namespace fjson
{
   ...
   */
  class size_stream : public virtual fjson::ostream
  {
      public:
  ...
  class iobuffer : public virtual fjson::iostream
  {
      public:
      iobuffer( size_t s )
      :_data(s){}
      ...
      virtual size_t     readsome( char* buf, size_t len )
      {
          ...
          if( avail == 0 ) throw fjson::eof_exception();
      ...
      char               peek()const 
      { 
          if( _pos == _data.size() ) throw fjson::eof_exception();
         return _data[_pos]; 
      }
