#pragma once
#include <fjson/uint128.hpp>   

#define FJSON_REAL128_PRECISION (uint64_t(1000000) * uint64_t(1000000) * uint64_t(1000000))
...
namespace fjson {
    ...
    * with 18 places.
    * Delegates to fjson::bigint for multiplication and division.
    */
   class real128
   {
      public:
